...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/modul/upload": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Base64 encoded metadata (modul_id, filename)",
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid headers or metadata",
                        "schema": {
                            "$ref": "#/definitions/domain.ErrorResponse"
                        }
                    },
        ...
        "/api/v1/modul/upload/slot/check": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/modul/upload/{upload_id}": {
            ...
            "head": {
                ...
                "responses": {
                    "200": {
                        "description": "Upload status with Upload-Offset and Upload-Length headers"
                    },
                    "401": {
                        "description": "Unauthorized",
                        "schema": {
        ...
        "/api/v1/modul/upload/{upload_id}/info": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "Upload info retrieved successfully",
                        "schema": {
                            "$ref": "#/definitions/domain.SuccessResponse"
                        }
                    },
        ...
        "/api/v1/modul/{id}/upload": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid headers or modul ID",
                        "schema": {
                            "$ref": "#/definitions/domain.ErrorResponse"
                        }
                    },
                    ...
                    "403": {
                        "description": "Forbidden - no access to modul",
                        "schema": {
                            "$ref": "#/definitions/domain.ErrorResponse"
                        }
                    },
        ...
        "/api/v1/modul/{id}/upload/{upload_id}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/modul/{id}/upload/{upload_id}/info": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/project/{id}/upload": {
            "post": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid headers or project ID",
                        "schema": {
                            "$ref": "#/definitions/domain.ErrorResponse"
                        }
                    },
        ...
        "/api/v1/project/{id}/upload/{upload_id}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/project/{id}/upload/{upload_id}/info": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/upload": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Base64 encoded metadata (nama_project, kategori, semester)",
                        "name": "Upload-Metadata",
                        "in": "header",
                        "required": true
                    }
