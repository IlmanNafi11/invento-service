    ...
    "paths": {
        ...
        "/api/v1/modul/download": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "ZIP file containing modules",
                        "schema": {
                            "type": "file"
                        }
                    },
        ...
        "/api/v1/modul/upload": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Base64-encoded metadata (filename, etc.)",
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "TUS error response",
                        "schema": {
                            "type": "string"
                        }
                    },
                    ...
                    "412": {
                        "description": "TUS version mismatch",
                        "schema": {
                            "type": "string"
                        }
                    },
        ...
        "/api/v1/modul/upload/{upload_id}": {
            "delete": {
                ...
                "responses": {
                    "204": {
                        "description": "No content (upload cancelled)",
                        "schema": {
                            "type": "string"
                        },
                        "headers": {
            ...
            "head": {
                ...
                "responses": {
                    "200": {
                        "description": "TUS headers with current offset and length",
                        "schema": {
                            "type": "string"
                        },
                        "headers": {
            ...
            "patch": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Upload ID from InitiateUpload",
                        "name": "upload_id",
                        "in": "path",
                        "required": true
                    },
                ...
                "responses": {
                    "204": {
                        "description": "No content (upload continuing)",
                        "schema": {
                            "type": "string"
                        },
                        "headers": {
                            ...
                            "Upload-Offset": {
                                "type": "string",
                                "description": "New offset after this chunk"
                            }
                        }
                    },
                    "400": {
                        "description": "Invalid chunk or offset",
                        "schema": {
                            "type": "string"
                        }
                    },
        ...
        "/api/v1/modul/{id}/update/{upload_id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Module ID being updated",
                        "name": "id",
                        "in": "path",
                        "required": true
                    },
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Upload ID from InitiateModulUpdateUpload",
                        "name": "upload_id",
                        "in": "path",
                        "required": true
                    },
