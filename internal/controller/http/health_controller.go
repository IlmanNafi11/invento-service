...
//	@Accept			json
//	@Produce		json
//	@Success		200	{object}	dto.SuccessResponse{data=dto.BasicHealthCheck}	"Server berjalan dengan baik"
//	@Router			/health [get]
...
//	@Accept			json
//	@Produce		json
//	@Success		200	{object}	dto.SuccessResponse{data=dto.SystemMetrics}	"Metrics sistem berhasil diambil"
