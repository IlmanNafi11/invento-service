...
// TestUserRepository_GetByEmail_NotFound tests user retrieval when user doesn't exist
func TestUserRepository_GetByEmail_NotFound(t *testing.T) {
	...
	result, err := userRepo.GetByEmail("nonexistent@example.com")
	assert.Error(t, err)
	assert.Nil(t, result)
}

// TestUserRepository_GetByEmail_Inactive tests user retrieval when user is inactive
func TestUserRepository_GetByEmail_Inactive(t *testing.T) {
	db, err := testhelper.SetupTestDatabase()
	require.NoError(t, err)
	defer testhelper.TeardownTestDatabase(db)
	...
	// Manually set inactive after creation (bypassing default)
...
// TestUserRepository_GetByID_NotFound tests user retrieval when user doesn't exist
