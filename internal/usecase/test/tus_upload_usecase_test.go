...
// Helper function to create test config for TUS upload
...
// TestInitiateUpload_Success tests successful upload initiation
func TestTusUploadUsecase_InitiateUpload_Success(t *testing.T) {
	...
	uc := usecase.NewTusUploadUsecase(mockTusUploadRepo, mockProjectRepo, nil, tusManager, fileManager, cfg)
